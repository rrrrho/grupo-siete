...
def reg_turno():
    ...
    while True:
        try:
            ...
            assert (valPaciente(dniTurno,'datos/pacientes.txt')==True), "Se ingresó un DNI que no pertenece a ningún paciente en la base de datos"
            ...
            #FALTA LA FUNCION valTurno PARA VERIFICAR QUE UN TURNO NO COLISIONE CON OTRO EN FECHA Y HORARIO!
            '''
            if valTurno(datos)==True:
                try:
